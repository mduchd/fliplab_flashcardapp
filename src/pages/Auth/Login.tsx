    ...
    <div className="min-h-screen flex bg-gradient-to-br from-blue-900 via-indigo-900 to-slate-900">
      ...
      <div className="w-full lg:w-1/2 flex items-start justify-center p-4 sm:p-8 pt-20 relative">
        ...
        <div className={`relative w-full max-w-md transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          ...
          <div className="relative bg-gradient-to-b from-slate-50/97 via-white/90 to-slate-100/92 backdrop-blur-2xl rounded-2xl p-7 sm:p-8 border-2 border-slate-300/60 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.4),0_20px_50px_-10px_rgba(0,0,0,0.2),0_10px_20px_-5px_rgba(0,0,0,0.15),0_0_0_1px_rgba(255,255,255,0.8)_inset,0_0_40px_0_rgba(59,130,246,0.08)] mt-12">
            <div className="mb-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-2.5 lg:py-2 pr-12 bg-white border-2 border-slate-200 rounded-lg text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-500 hover:border-slate-300 transition-all [&::-ms-reveal]:hidden [&::-webkit-credentials-auto-fill-button]:hidden"
                    placeholder="••••••••"
                    required
                  />
                  <button
